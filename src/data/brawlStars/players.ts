...
const players: BrawlStars["players"] = {
    pins: [
        {
            type: "starting",
            values: [
        ...
        {
            type: "championship-challenge-2021",
            values: [
                {
        ...
        {
            type: "brawlentines-challenge-2022",
            values: [
                {
